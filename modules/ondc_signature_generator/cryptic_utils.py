...
f = open(os.getenv("REQUEST_BODY_PATH", "modules/ondc_signature_generator/request_body_raw_text.txt"), "r")
...
def create_authorisation_header(request_body=request_body_raw_text, created=None, expires=None):
    ...
    signature = sign_response(signing_key, private_key=os.environ.get("PRIVATE_KEY"))

    subscriber_id = os.environ.get("SUBSCRIBER_ID", "dev-ondc-buyer-api.chartr.in")
    unique_key_id = os.environ.get("UNIQUE_KEY_ID", "41c42b3f-91b2-48d3-9de0-19470676578d")
