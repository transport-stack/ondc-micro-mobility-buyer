...
# import json
#
# import modules.pg.phonepeswitch.api as phonepe_api
#
...
# """
#
# phonepe_api.MERCHANT_ID = "CHARTRUAT"
# phonepe_api.STORE_ID = "test_store"
# phonepe_api.TERMINAL_ID = "test_terminal"
#
# api_keys = {"1": "645767a3-fc7a-4639-9430-c16c510fd5b5", "2": "key2"}
#
# phonepe_api.API_KEYS.update(api_keys)
#
# customer_mobile_number = "1234567890"
# salt_key_index = "1"
# new_transaction_id = datetime.datetime.now().strftime(
#     "%Y%m%d%H%M%S"
# )  # Setting the current date and time as orderId, for example
#
...
#
# # response = phonepe_api.make_status_request("20211202151109", salt_key_index)
#
